...
permalink: /publication/2025-12-16-mqtt-autonomous-vehicle
...
**Abstract:**  
This study focuses on the design and implementation of an MQTT-based system to visualize the behavior of autonomous vehicles in a virtual environment using Internet of Things (IoT) technology. The primary objective is to simulate and monitor vehicle-to-environment and vehicle-to-vehicle interactions within a connected ecosystem. As advancements in IoT and intelligent transportation systems accelerate the transition from traditional to autonomous vehicles, there is a growing need for frameworks that enable cooperative decision-making beyond isolated sensor-based perception.
